  ...
  return (
    ...
    >
      ...
      >
        ...
        <Card className="absolute inset-0 w-full h-full backface-hidden glassmorphism border-2 border-primary/30 hover:border-primary/70 transition-all duration-300 hover:glow-primary">
          <div className="p-6 h-full flex flex-col justify-between">
            ...
            <div className="text-center">
              <div className="text-sm text-accent font-medium">Hover to see solution</div>
            </div>
          </div>
        </Card>

        {/* Back of card - Solution */}
        <Card className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 border-2 border-primary/50 glow-primary">
          <div className="p-6 h-full flex flex-col justify-between">
            <div>
